    ...
    def loss(self,
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                # self.logger.info('bbox_pred = ' + str(bbox_pred))
                # self.logger.info('pos_bbox_pred' + str(pos_bbox_pred))
                # self.logger.info('bbox_targets[pos_inds.type(torch.bool)] = ' + str(bbox_targets[pos_inds.type(torch.bool)]))
                # self.logger.info('bbox_weights[pos_inds.type(torch.bool)] = ' + str(bbox_weights[pos_inds.type(torch.bool)]))
                # self.logger.info('bbox_targets.size(0)=' + str(bbox_targets.size(0)))
