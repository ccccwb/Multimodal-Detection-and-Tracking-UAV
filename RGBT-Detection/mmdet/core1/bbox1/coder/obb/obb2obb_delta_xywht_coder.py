...
class OBB2OBBDeltaXYWHTCoder(BaseBBoxCoder):
    ...
    def __init__(self,
        ...
        self.logger = get_root_logger(log_level=logging.INFO) #############################


    def encode(self, bboxes, gt_bboxes):
        assert bboxes.size(0) == gt_bboxes.size(0)
        assert gt_bboxes.size(-1) == bboxes.size(-1) == 5
        encoded_bboxes = obb2delta(self,bboxes, gt_bboxes, self.means, self.stds)   ##self 到时记得删掉
...
def obb2delta(self, proposals, gt, means=(0., 0., 0., 0., 0.), stds=(1., 1., 1., 1., 1.)):
    ...
    # self.logger.info('py = '+ str(py))
    # self.logger.info('pw = '+ str(pw))
    # self.logger.info('ph = '+ str(ph))
    # self.logger.info('ptheta = '+ str(ptheta))
    # self.logger.info('gx = '+ str(gx))
    # self.logger.info('gy = '+ str(gy))
    # self.logger.info('gw = '+ str(gw))
    # self.logger.info('gh = '+ str(gh))
    # self.logger.info('gtheta = '+ str(gtheta))
    # self.logger.info('dx = '+ str(dx))
    # self.logger.info('dy = '+ str(dy))
    # self.logger.info('dw = '+ str(dw))
    # self.logger.info('dh = '+ str(dh))
    # self.logger.info('dtheta = '+ str(dtheta))
